...
import com.rdb.refresh.RefreshRequest;

import java.util.ArrayList;
import java.util.List;

//Volley请求组合示例
public class RefreshVolleyRequest<D> extends RefreshRequest<D> implements Response.Listener<String>, Response.ErrorListener {

    private String url;
    private Class<D> dClass;
    private RequestQueue requestQueue;

    public RefreshVolleyRequest(RequestQueue requestQueue, String url, Class<D> dClass) {
        this.url = url;
        this.dClass = dClass;
